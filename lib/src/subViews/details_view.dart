...
class _DetailsViewState extends State<DetailsView> {
  ...
  Future<String?> _getDescription(BuildContext context) async { 
    if (widget.fishName != ""){
      final photoProvider = Provider.of<PhotosPecesProvider>(context, listen: false);
      final recognizedProvider = Provider.of<PecesRecognizedProvider>(context, listen: false);
      final PezRecognized? pez = recognizedProvider.getPezPorNombre(widget.fishName);
      ...
      return await ChatService().request("dame información en español y datos curiosos sobre el pez ${widget.fishName}, se breve");
    }else{
